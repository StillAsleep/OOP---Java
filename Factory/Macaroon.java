public class Macaroon implements Factory {

    @Override
    public void createCookie(String Macaroon) {
        System.out.println("Here is the Macaroon Recipe: ");
    }

    @Override
    public void getRecipe() {
        System.out.println("For the Macarons:");
        System.out.println("1. Sift the confectioners sugar and almond flour into a bowl.");
        System.out.println("2. Add the room temperature egg whites into a very clean bowl.");
        System.out.println(
        ...
        System.out
                .println("4. Add the food coloring (if desired) and mix in. Continue to beat until stiff peaks form.");
        System.out.println("5. Begin folding in the 1/3 of the dry ingredients.");
        System.out.println("6. Be careful to add the remaining dry ingredients and fold gently.");
        System.out.println(
        ...
        System.out.println("\n");
        System.out.println("For the French Buttercream Filling: ");
        System.out.println(
